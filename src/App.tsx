/**
 * TailAdmin React TypeScript Pro - App Component
 * 
 * @file Main application routing component
 * 
 * AI-ASSISTANT GUIDELINES:
 * - DO NOT modify the existing folder structure
 * - DO NOT alter component organization patterns
 * - DO NOT change routing configuration approach
 * - DO use correct layout wrappers for different route types
 * - DO maintain dark mode support in all UI components
 * - See .github/AI_DEVELOPMENT.md for critical rules
 */
